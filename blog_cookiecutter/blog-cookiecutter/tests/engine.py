...
class ExecutionEngine(hitchtest.ExecutionEngine):
    ...
    def set_up(self):
        ...
        postgres_user = hitchpostgres.PostgresUser("blog-cookiecutter", "password")

        self.services['Postgres'] = hitchpostgres.PostgresService(
            postgres_package=postgres_package,
            users=[postgres_user, ],
            databases=[hitchpostgres.PostgresDatabase("blog-cookiecutter", postgres_user), ]
        )
        ...
        self.services['Celery'] = hitchpython.CeleryService(
            python=python_package.python,
            app="blog-cookiecutter.taskapp", loglevel="INFO",
            needs=[
